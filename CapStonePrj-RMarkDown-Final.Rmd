...
knitr::opts_chunk$set(results = "hide", echo = TRUE, warning = FALSE, fig.show = 'hide')
library(ggplot2)
library(corrplot)
library(dplyr)
library(gvlma)
...
```{r results = "hide", echo = TRUE, warning = FALSE, fig.show = 'hide'}
...
(GHG 1-10 , 10 being good rating) Higher fuel economy is associated with better GHG emissions and better GHG rating. So cars with higher miles per gallon are more environmental friendly. 
...
####  Correlation between City Fuel and Engine Displacment
